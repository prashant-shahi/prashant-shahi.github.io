        ...
        <div class="relative w-100 mb4 bg-white">
            <div class="bg-white mb2 pv3 ph4 gray overflow-hidden">
                ...
                <div class="nested-links f5 lh-copy nested-copy-line-height">
                    Currently, I am working as a Developer Advocate Engineer at Dgraph Labs, San Francisco-based graph
                    database company. Dgraph is written entirely in Golang and it is open-source. It is also
                    the only database in the market right now that natively supports GraphQL.
                </div>
            </div>
        </div>
        <div class="relative w-100 mb4 bg-white">
            <div class="bg-white mb2 pv3 ph4 gray overflow-hidden tc-l center">
                ...
                <div class="nested-links f5 lh-copy nested-copy-line-height">
                    ...
                    I majorly contributed to their DevOps infrastructure.
                </div>
            </div>
        </div>
        <div class="relative w-100 mb4 bg-white">
            <div class="bg-white mb2 pv3 ph4 gray overflow-hidden">
                ...
                <div class="nested-links f5 lh-copy nested-copy-line-height">
                    In the past, I have remotely worked for Noodles Factory, where I worked in building the
                    backend for AI-powered Chatbot, Walter from the very early stage.
                </div>
            </div>
        </div>
    </aside>
